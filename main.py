...
titleLabel = Label(titleframe,text = "My Typing Test",font = ('algerian',28,'bold'),bg = 'goldenrod3',fg = 'white'
                 ,width = 38,bd = 10)
...
paragraph_list = [' I failed the first quarter of a class in middle school, so I made a fake report card. I did this every quarter that year. I forgot that they mail home the end-of-year cards, and my mom got it before I could intercept with my fake. She was PISSED—at the school for their error. The teacher also retired that year and had already thrown out his records, so they had to take my mother’s “proof” (the fake ones I made throughout the year) and “correct” the “mistake.” ',
                    ...
                    'I was driving with my friends a week ago when I saw a beautiful forest on top of a mountain. It looked so great that i thought that i should exit the expressway and start climbing the mountain. That is when I decided to get a long weekend from my work and setup a temporary camp with my friend for 3 days. I started packing food in small quantites so we do not have to open huge packets and let the humidity ruin it. I took my bag of cloths and food and it was a fun long weekend with nature and my friend'
